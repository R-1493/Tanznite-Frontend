  ...
  return (
    <section>
      <div className="relative h-auto overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <div class="mt-10 p-3 flex flex-col xl:flex-row jusitfy-center items-stretch w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
            ...
            <div class="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50  space-y-6">
              ...
              <div class="flex justify-center items-center w-full space-y-4 flex-col border-gray-200 border-b pb-4">
                <div class="flex justify-between w-full">
                  ...
                  <p class="text-base  leading-4 text-gray-600">${total}</p>
                </div>
          ...
          <div class="w-full flex justify-center items-center">
            <button class="hover:bg-indigo-700   focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 py-5 w-96 md:w-full bg-[#6F64B1] text-base font-medium leading-4 text-white">
              Order
            </button>
          </div>
            ...
            <div class="flex flex-col md:flex-row xl:flex-col justify-start items-stretch h-full w-full md:space-x-6 lg:space-x-8 xl:space-x-0">
              ...
              <div class="flex justify-between xl:h-full items-stretch w-full flex-col mt-6 md:mt-0">
                ...
                <div class="flex w-full justify-center items-center md:justify-start md:items-start">
                  <button class="mt-6 md:mt-0   py-5 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 border border-gray-800 font-medium w-96 2xl:w-full text-base font-medium leading-4 text-gray-800">
                    Edit Details
                  </button>
                </div>
              </div>
